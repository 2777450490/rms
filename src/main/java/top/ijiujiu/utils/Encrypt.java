...
public class Encrypt {
	 ...
	 * @throws Exception
	 */
	public static String encryptRMS(String str) throws Exception {
		String key = "tkGGRmBErvc=";
		String iv = "Kl7ZgtM1dvQ=";
		byte[] keybyte = Base64.decodeBase64(key);
		byte[] ivbyte = Base64.decodeBase64(iv);
		byte[] desstring = Encrypt.encrypt(str.getBytes(), keybyte, ivbyte);
		return Base64.encodeBase64String(desstring);
